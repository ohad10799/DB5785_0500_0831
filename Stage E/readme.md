<p align="center">
  <strong>Hotel Management System - README</strong>
</p>
...
<strong>שלב א' - יצירת מסד הנתונים</strong><br><br>
1. מבוא<br>
2. Entity-Relationship Diagram (ERD)<br>
3. Data Structure Diagram (DSD)<br>
4. שיטות להכנסת נתונים<br>
5. Backup and Restore<br><br>

<strong>שלב ב' - שאילתות בסיסיות ומתקדמות</strong><br><br>
6. Queries<br>
7. Constraints<br>
8. Rollback and Commit<br><br>

<strong>שלב ג' - אינטגרציה</strong><br><br>
9. תרשימי DSD ו־ERD - צילומי מסך<br>
10. הסבר על החלטות בתהליך האינטגרציה<br>
11. תהליך האינטגרציה - הסבר מילולי עם פקודות<br>
12. מבטים (Views)<br>
13. תיאור כל מבט<br>
14. פלט של כל מבט<br>
15. שאילתות על מבטים<br>
16. הסבר מילולי של כל שאילתא<br>
17. קוד SQL<br>
18. פלט שאילתא<br><br>

<strong>שלב ד' - פונקציות, פרוצדורות וטריגרים</strong><br><br>
19. עבור כל תוכנית (פונקציה / פרוצדורה / טריגר):<br>
20. תיאור מילולי של מטרת הקוד<br>
21. קוד מלא של הפונקציה / הפרוצדורה / הטריגר<br>
22. צילום מסך של ההפעלה<br><br>

<strong>שלב ה' - ממשק גרפי</strong><br><br>
23. הוראות הפעלה של האפליקציה<br>
24. הסבר על דרך העבודה<br>
25. מסכים עיקריים במערכת<br>
26. צילומי מסך מכל אחד מהמסכים בפעולה<br>
...
3.  העלאת רמת המנוי לכל מי שיש לו מעל 80 נקודות
> ![](media/image41.png)
...
<p align="right">
1. הצגת כל החדרים עם 0 הזמנות<br>
...
<p align="right">1.  ההעדפה הכי פופולרית</p>

<p align="right">2.  כל ההעדפות עם יותר מ־30 הזמנות</p>
...
> ומעלה.
>
**פעולה:** מעדכנת את שדה pointsBalance בטבלת subscription.
> ![](media/image95.png)![](media/image96.png)
...
לפני שהמסך הראשי מתחיל לפעול, בנינו קוד נפרד (קובץ db.py) לחיבור של המערכת למסדר הנתונים. כל מסך שצריך לגשת למסד הנתונים, ייבא את הקוד ויתחבר כך למסד הנתונים.
...
במסך יצירת הזמנה, נוכל ליצור הזמנה חדשה.
